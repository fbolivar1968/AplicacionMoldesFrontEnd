...
export const MechanicalFormSchema = z.object({
    ac_IdAcero: z.coerce.number().optional().nullable(),
    du_IdDureza: z.coerce.number().optional().nullable(),
    pr_IdProveedor: z.coerce.number().optional().nullable(),
    php_PrecioTotal: z.coerce.number().min(0, "El precio debe ser mayor o igual a 0").optional().nullable().or(z.literal("")),
    ph_FechaCreacion: z.string().optional().nullable(),
    ph_DescripHerra: z.string().max(500, "Máximo 500 caracteres").optional().nullable(),
});
