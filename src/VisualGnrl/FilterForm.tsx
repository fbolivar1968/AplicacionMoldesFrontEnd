...
export default function FilterForm({
    ...
    return (
        <>
            ...
            shadow-3xl fixed inset-y-0 left-0 z-50 w-72 p-4
            transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'}`} >

                <button
                    type="button"
                    className="absolute top-10 left-full z-50 p-2 rounded-r-md bg-orangeFB text-white shadow-md hover:bg-orange-600 focus:outline-none cursor-pointer flex items-center justify-center"
                    onClick={toggleOpen}
                >
